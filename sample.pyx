...
class OLSSuite:
    ...
    GetOLSResults: This method fits the model object with the OLS results of a specified independent 
    ...
    GetAltOLS: This method is a variation of the standard OLS methodology. Instead of assuming all 
               ...
               algorithm tests non linear relationships. If an improvement in R2 greater than the 
    ...
    Coefficients: Numpy array of the coefficients in the order variables were 
...
def Get1SampleTTest(fusedDType[:] x, double popMean):
    ...
    statistically different than a given population mean.
